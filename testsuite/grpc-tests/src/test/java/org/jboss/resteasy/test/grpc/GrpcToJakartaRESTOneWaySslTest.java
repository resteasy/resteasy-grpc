...
public class GrpcToJakartaRESTOneWaySslTest extends AbstractGrpcToJakartaRESTTest {
    ...
    public static Archive<?> deployPlainText() throws Exception {
        return doDeploy(GrpcToJakartaRESTOneWaySslTest.class.getSimpleName());
    }

    private static ManagedChannel channelSslOneway;

    private static CC1ServiceGrpc.CC1ServiceBlockingStub blockingStubSslOneway;

    private static CC1ServiceGrpc.CC1ServiceStub asyncStubSslOneway;
    ...
    public static void beforeClass() throws Exception {
        ...
        ChannelCredentials creds = TlsChannelCredentials.newBuilder()
                ...
                .build();
        channelSslOneway = Grpc.newChannelBuilderForAddress("localhost", 9555, creds).build();
