...
import dev.resteasy.grpc.example.CC1_proto.ELEMENT_WRAPPER;
...
public class CC1JavabufTranslator_save implements JavabufTranslator {
    ...
    static {
        ...
        fromJavabufClassMap.put(java_util_LinkedHashMap_HIDDEN_Entry.class.getName(),
                getReturnNonPublicJavaClass("java.util.LinkedHashMap$Entry").getJavaClass());
        ...
        fromJavabufClassMap.put(java_util_HashMap_HIDDEN_TreeNode.class.getName(),
                getReturnNonPublicJavaClass("java.util.HashMap$TreeNode").getJavaClass());
        ...
        fromJavabufClassMap.put(java_util_ArrayList_HIDDEN_ListItr.class.getName(),
                getReturnNonPublicJavaClass("java.util.ArrayList$ListItr").getJavaClass());
        ...
        fromJavabufClassMap.put(java_util_HashMap_HIDDEN_KeyIterator.class.getName(),
                getReturnNonPublicJavaClass("java.util.HashMap$KeyIterator").getJavaClass());
        ...
        fromJavabufClassMap.put(java_util_HashMap_HIDDEN_Values.class.getName(),
                getReturnNonPublicJavaClass("java.util.HashMap$Values").getJavaClass());
        ...
        fromJavabufClassMap.put(java_util_HashMap_HIDDEN_EntrySet.class.getName(),
                getReturnNonPublicJavaClass("java.util.HashMap$EntrySet").getJavaClass());

        toJavabufMap.put("java.util.HashMap$ValueSpliterator", new java_util_HashMap_HIDDEN_ValueSpliterator_ToJavabuf());
        fromJavabufMap.put("java_util_HashMap_HIDDEN_ValueSpliterator",
                new java_util_HashMap_HIDDEN_ValueSpliterator_FromJavabuf());
        toJavabufClassMap.put("java.util.HashMap$ValueSpliterator", java_util_HashMap_HIDDEN_ValueSpliterator.class);
        fromJavabufClassMap.put(java_util_HashMap_HIDDEN_ValueSpliterator.class.getName(),
                getReturnNonPublicJavaClass("java.util.HashMap$ValueSpliterator").getJavaClass());
        ...
        fromJavabufClassMap.put(java_util_HashMap_HIDDEN_ValueIterator.class.getName(),
                getReturnNonPublicJavaClass("java.util.HashMap$ValueIterator").getJavaClass());

        toJavabufMap.put("dev.resteasy.grpc.example.CC1$InnerClass",
                new dev_resteasy_grpc_example_CC1_INNER_InnerClass_ToJavabuf());
        fromJavabufMap.put("dev_resteasy_grpc_example_CC1_INNER_InnerClass",
                new dev_resteasy_grpc_example_CC1_INNER_InnerClass_FromJavabuf());
        toJavabufClassMap.put("dev.resteasy.grpc.example.CC1$InnerClass", dev_resteasy_grpc_example_CC1_INNER_InnerClass.class);
        fromJavabufClassMap.put(dev_resteasy_grpc_example_CC1_INNER_InnerClass.class.getName(),
                dev.resteasy.grpc.example.CC1.InnerClass.class);

        toJavabufMap.put("java.util.AbstractMap$SimpleEntry", new java_util_AbstractMap_INNER_SimpleEntry_ToJavabuf());
        fromJavabufMap.put("java_util_AbstractMap_INNER_SimpleEntry",
                new java_util_AbstractMap_INNER_SimpleEntry_FromJavabuf());
        toJavabufClassMap.put("java.util.AbstractMap$SimpleEntry", java_util_AbstractMap_INNER_SimpleEntry.class);
        fromJavabufClassMap.put(java_util_AbstractMap_INNER_SimpleEntry.class.getName(),
                java.util.AbstractMap.SimpleEntry.class);

        toJavabufMap.put("java.util.AbstractMap$SimpleImmutableEntry",
                new java_util_AbstractMap_INNER_SimpleImmutableEntry_ToJavabuf());
        fromJavabufMap.put("java_util_AbstractMap_INNER_SimpleImmutableEntry",
                new java_util_AbstractMap_INNER_SimpleImmutableEntry_FromJavabuf());
        toJavabufClassMap.put("java.util.AbstractMap$SimpleImmutableEntry",
                java_util_AbstractMap_INNER_SimpleImmutableEntry.class);
        fromJavabufClassMap.put(java_util_AbstractMap_INNER_SimpleImmutableEntry.class.getName(),
        ...
        fromJavabufClassMap.put(java_util_HashMap_HIDDEN_KeySet.class.getName(),
                getReturnNonPublicJavaClass("java.util.HashMap$KeySet").getJavaClass());

        toJavabufMap.put("dev.resteasy.grpc.example.ArrayStuff$Stuff",
                new dev_resteasy_grpc_example_ArrayStuff_HIDDEN_Stuff_ToJavabuf());
        fromJavabufMap.put("dev_resteasy_grpc_example_ArrayStuff_HIDDEN_Stuff",
                new dev_resteasy_grpc_example_ArrayStuff_HIDDEN_Stuff_FromJavabuf());
        toJavabufClassMap.put("dev.resteasy.grpc.example.ArrayStuff$Stuff",
                dev_resteasy_grpc_example_ArrayStuff_HIDDEN_Stuff.class);
        fromJavabufClassMap.put(dev_resteasy_grpc_example_ArrayStuff_HIDDEN_Stuff.class.getName(),
                getReturnNonPublicJavaClass("dev.resteasy.grpc.example.ArrayStuff$Stuff").getJavaClass());

        toJavabufMap.put("java.util.ArrayList$ArrayListSpliterator",
                new java_util_ArrayList_HIDDEN_ArrayListSpliterator_ToJavabuf());
        fromJavabufMap.put("java_util_ArrayList_HIDDEN_ArrayListSpliterator",
                new java_util_ArrayList_HIDDEN_ArrayListSpliterator_FromJavabuf());
        toJavabufClassMap.put("java.util.ArrayList$ArrayListSpliterator",
                java_util_ArrayList_HIDDEN_ArrayListSpliterator.class);
        fromJavabufClassMap.put(java_util_ArrayList_HIDDEN_ArrayListSpliterator.class.getName(),
                getReturnNonPublicJavaClass("java.util.ArrayList$ArrayListSpliterator").getJavaClass());
        ...
        fromJavabufClassMap.put(java_util_ArrayList_HIDDEN_SubList.class.getName(),
                getReturnNonPublicJavaClass("java.util.ArrayList$SubList").getJavaClass());
        ...
        fromJavabufClassMap.put(java_util_HashMap_HIDDEN_UnsafeHolder.class.getName(),
                getReturnNonPublicJavaClass("java.util.HashMap$UnsafeHolder").getJavaClass());
        ...
        fromJavabufClassMap.put(java_util_AbstractList_HIDDEN_ListItr.class.getName(),
                getReturnNonPublicJavaClass("java.util.AbstractList$ListItr").getJavaClass());

        toJavabufMap.put("dev.resteasy.grpc.example.CC3$CC3_Sub", new dev_resteasy_grpc_example_CC3_INNER_CC3_Sub_ToJavabuf());
        fromJavabufMap.put("dev_resteasy_grpc_example_CC3_INNER_CC3_Sub",
                new dev_resteasy_grpc_example_CC3_INNER_CC3_Sub_FromJavabuf());
        toJavabufClassMap.put("dev.resteasy.grpc.example.CC3$CC3_Sub", dev_resteasy_grpc_example_CC3_INNER_CC3_Sub.class);
        fromJavabufClassMap.put(dev_resteasy_grpc_example_CC3_INNER_CC3_Sub.class.getName(),
                dev.resteasy.grpc.example.CC3.CC3_Sub.class);
        ...
        fromJavabufClassMap.put(java_util_ArrayList_HIDDEN_Itr.class.getName(),
                getReturnNonPublicJavaClass("java.util.ArrayList$Itr").getJavaClass());
        ...
        fromJavabufClassMap.put(java_util_HashMap_HIDDEN_EntryIterator.class.getName(),
                getReturnNonPublicJavaClass("java.util.HashMap$EntryIterator").getJavaClass());
        ...
        fromJavabufClassMap.put(java_util_HashMap_HIDDEN_HashIterator.class.getName(),
                getReturnNonPublicJavaClass("java.util.HashMap$HashIterator").getJavaClass());

        toJavabufMap.put("java.util.AbstractList$RandomAccessSpliterator",
                new java_util_AbstractList_HIDDEN_RandomAccessSpliterator_ToJavabuf());
        fromJavabufMap.put("java_util_AbstractList_HIDDEN_RandomAccessSpliterator",
                new java_util_AbstractList_HIDDEN_RandomAccessSpliterator_FromJavabuf());
        toJavabufClassMap.put("java.util.AbstractList$RandomAccessSpliterator",
                java_util_AbstractList_HIDDEN_RandomAccessSpliterator.class);
        fromJavabufClassMap.put(java_util_AbstractList_HIDDEN_RandomAccessSpliterator.class.getName(),
                getReturnNonPublicJavaClass("java.util.AbstractList$RandomAccessSpliterator").getJavaClass());
        ...
        fromJavabufMap.put("java_util_HashMap_HIDDEN_KeySpliterator",
                new java_util_HashMap_HIDDEN_KeySpliterator_FromJavabuf());
        toJavabufClassMap.put("java.util.HashMap$KeySpliterator", java_util_HashMap_HIDDEN_KeySpliterator.class);
        fromJavabufClassMap.put(java_util_HashMap_HIDDEN_KeySpliterator.class.getName(),
                getReturnNonPublicJavaClass("java.util.HashMap$KeySpliterator").getJavaClass());
        ...
        fromJavabufClassMap.put(java_util_AbstractList_HIDDEN_SubList.class.getName(),
                getReturnNonPublicJavaClass("java.util.AbstractList$SubList").getJavaClass());
        ...
        fromJavabufMap.put("java_util_HashMap_HIDDEN_EntrySpliterator",
                new java_util_HashMap_HIDDEN_EntrySpliterator_FromJavabuf());
        toJavabufClassMap.put("java.util.HashMap$EntrySpliterator", java_util_HashMap_HIDDEN_EntrySpliterator.class);
        fromJavabufClassMap.put(java_util_HashMap_HIDDEN_EntrySpliterator.class.getName(),
                getReturnNonPublicJavaClass("java.util.HashMap$EntrySpliterator").getJavaClass());

        toJavabufMap.put("java.util.AbstractList$RandomAccessSubList",
                new java_util_AbstractList_HIDDEN_RandomAccessSubList_ToJavabuf());
        fromJavabufMap.put("java_util_AbstractList_HIDDEN_RandomAccessSubList",
                new java_util_AbstractList_HIDDEN_RandomAccessSubList_FromJavabuf());
        toJavabufClassMap.put("java.util.AbstractList$RandomAccessSubList",
                java_util_AbstractList_HIDDEN_RandomAccessSubList.class);
        fromJavabufClassMap.put(java_util_AbstractList_HIDDEN_RandomAccessSubList.class.getName(),
                getReturnNonPublicJavaClass("java.util.AbstractList$RandomAccessSubList").getJavaClass());
        ...
        fromJavabufClassMap.put(dev_resteasy_grpc_example___ArrayStuff.class.getName(),
                dev.resteasy.grpc.example.ArrayStuff.class);

        toJavabufMap.put("java.util.HashMap$HashMapSpliterator", new java_util_HashMap_HIDDEN_HashMapSpliterator_ToJavabuf());
        fromJavabufMap.put("java_util_HashMap_HIDDEN_HashMapSpliterator",
                new java_util_HashMap_HIDDEN_HashMapSpliterator_FromJavabuf());
        toJavabufClassMap.put("java.util.HashMap$HashMapSpliterator", java_util_HashMap_HIDDEN_HashMapSpliterator.class);
        fromJavabufClassMap.put(java_util_HashMap_HIDDEN_HashMapSpliterator.class.getName(),
                getReturnNonPublicJavaClass("java.util.HashMap$HashMapSpliterator").getJavaClass());
        ...
        fromJavabufClassMap.put(java_util_HashMap_HIDDEN_Node.class.getName(),
                getReturnNonPublicJavaClass("java.util.HashMap$Node").getJavaClass());
        ...
        fromJavabufClassMap.put(java_util_AbstractList_HIDDEN_Itr.class.getName(),
                getReturnNonPublicJavaClass("java.util.AbstractList$Itr").getJavaClass());
        ...
        toJavabufMap.put("dev.resteasy.grpc.bridge.runtime.sse.SseEvent",
                new dev_resteasy_grpc_bridge_runtime_sse___SseEvent_ToJavabuf());
        fromJavabufMap.put("dev_resteasy_grpc_bridge_runtime_sse___SseEvent",
                new dev_resteasy_grpc_bridge_runtime_sse___SseEvent_FromJavabuf());
        toJavabufClassMap.put("dev.resteasy.grpc.bridge.runtime.sse.SseEvent",
                dev_resteasy_grpc_bridge_runtime_sse___SseEvent.class);
        fromJavabufClassMap.put(dev_resteasy_grpc_bridge_runtime_sse___SseEvent.class.getName(),
                dev.resteasy.grpc.bridge.runtime.sse.SseEvent.class);
    ...
    public Object translateFromJavabuf(Message message) {
        if (Array_proto.dev_resteasy_grpc_arrays___ArrayHolder.class.equals(message.getClass())) {
            try {
                return ArrayUtility.getArray(this, (Array_proto.dev_resteasy_grpc_arrays___ArrayHolder) message);
            } catch (Exception e) {
                    ...
                    if (field.getType().isArray()) {
                        ...
                        if (componentType.isArray()) {
                            ...
                            for (int i = 0; i < Array.getLength(array); i++) {
                                if (Array.get(array, i) != null) {
                                    messageBuilder.addRepeatedField(fd,
                                            Any.pack(translator.translateToJavabuf(Array.get(array, i))));
                                }
                            }
                        } else {
                            messageBuilder.addRepeatedField(fd,
                            ...
                            for (int i = 0; i < Array.getLength(array); i++) {
                                if (Array.get(array, i) != null) {
                                    messageBuilder.addRepeatedField(fd,
                                            wrapArrayElement(translator.translateToJavabuf(Array.get(array, i)), i));
                                }
                            }
                        }
                        ...
                        if (field.get(obj) != null) {
                            ...
                            && toJavabufMap.keySet().contains(field.getType().getName())) {
            ...
            AssignFromJavabuf assignFromJavabuf = (message, object) -> {
                try {
                    ...
                    if (field.getType().isArray()) {
                        ...
                        } else if ("dev_resteasy_grpc_arrays___ArrayHolder"
                                .equals(typeName.substring(typeName.lastIndexOf(".") + 1))) {
                            dev_resteasy_grpc_arrays___ArrayHolder ah = (dev_resteasy_grpc_arrays___ArrayHolder) message
                                    .getField(fd);
                            ...
                            if (message.getField(fd).getClass().getPackage().getName().startsWith("com.google.protobuf")) {
                                ...
                                if (fd.getMessageType().getName().endsWith("ELEMENT_WRAPPER")) {
                                    if (field.get(object) == null) {
                                        ...
                                        Utility.setField(field, object,
                                                Array.newInstance(field.getType().getComponentType(), size), INSTANCE);
                                    }
                    ...
                    } else if (JavaType.MESSAGE.equals(fd.getJavaType())
                            && Array_proto.dev_resteasy_grpc_arrays___ArrayHolder.class.getSimpleName()
                                    .equals(fd.getMessageType().getName())) {
                        dev_resteasy_grpc_arrays___ArrayHolder submessage = (dev_resteasy_grpc_arrays___ArrayHolder) message
                                .getField(fd);
                        Object o = ArrayUtility.getArray(translator, submessage);
                    } else {
                        Object ooo = message.getField(fd);
                        if (Integer.class.equals(ooo.getClass())
                                && (Byte.class.equals(field.getType()) || byte.class.equals(field.getType()))) {
                            Utility.setField(field, object, ((Integer) ooo).byteValue(), INSTANCE);
                        } else if (Integer.class.equals(ooo.getClass())
                                && (Short.class.equals(field.getType()) || short.class.equals(field.getType()))) {
                            Utility.setField(field, object, ((Integer) ooo).shortValue(), INSTANCE);
                        } else if (Integer.class.equals(ooo.getClass())
                                && (Character.class.equals(field.getType()) || char.class.equals(field.getType()))) {
    ...
    static Message wrapArrayElement(Message m, int position) {
        ELEMENT_WRAPPER.Builder builder = ELEMENT_WRAPPER.newBuilder();
        switch (squashName(m.getDescriptorForType().getName())) {
            case "ginteger":
                builder.setGIntegerField((dev.resteasy.grpc.example.CC1_proto.gInteger) m);
                builder.setPosition(position);
                return builder.build();
            case "any":
                builder.setAnyField((com.google.protobuf.Any) m);
                builder.setPosition(position);
                return builder.build();
            case "gfloat":
                builder.setGFloatField((dev.resteasy.grpc.example.CC1_proto.gFloat) m);
                builder.setPosition(position);
                return builder.build();
            case "gdouble":
                builder.setGDoubleField((dev.resteasy.grpc.example.CC1_proto.gDouble) m);
                builder.setPosition(position);
                return builder.build();
            case "devresteasygrpcexamplearraystuffhiddenstuff":
                builder.setDevResteasyGrpcExampleArrayStuffHIDDENStuffField(
                        (dev.resteasy.grpc.example.CC1_proto.dev_resteasy_grpc_example_ArrayStuff_HIDDEN_Stuff) m);
                builder.setPosition(position);
                return builder.build();
            case "javautilhashmaphiddennode":
                builder.setJavaUtilHashMapHIDDENNodeField(
                        (dev.resteasy.grpc.example.CC1_proto.java_util_HashMap_HIDDEN_Node) m);
                builder.setPosition(position);
                return builder.build();
            case "gboolean":
                builder.setGBooleanField((dev.resteasy.grpc.example.CC1_proto.gBoolean) m);
                builder.setPosition(position);
                return builder.build();
        }
        return m;
    ...
    static Message unwrapArrayElement(ELEMENT_WRAPPER wrapper) {
        if (wrapper.hasGIntegerField()) {
            return wrapper.getGIntegerField();
        }
        if (wrapper.hasAnyField()) {
            return wrapper.getAnyField();
        }
        if (wrapper.hasGFloatField()) {
            return wrapper.getGFloatField();
        }
        if (wrapper.hasGDoubleField()) {
            return wrapper.getGDoubleField();
        }
        if (wrapper.hasDevResteasyGrpcExampleArrayStuffHIDDENStuffField()) {
            return wrapper.getDevResteasyGrpcExampleArrayStuffHIDDENStuffField();
        }
        if (wrapper.hasJavaUtilHashMapHIDDENNodeField()) {
            return wrapper.getJavaUtilHashMapHIDDENNodeField();
        }
        if (wrapper.hasGBooleanField()) {
            return wrapper.getGBooleanField();
        }
        throw new RuntimeException("unrecognized field: " + wrapper);
    }

    static class ELEMENT_WRAPPER_ToJavabuf implements TranslateToJavabuf {
        private static Descriptor descriptor = dev.resteasy.grpc.example.CC1_proto.ELEMENT_WRAPPER.getDescriptor();
        ...
        static {
            for (FieldDescriptor f : descriptor.getFields()) {
                ...
                assignList.add(toJavabuf(ELEMENT_WRAPPER.class, descriptor.findFieldByName(name)));
            }
        }
    ...
    static class gShort_ToJavabuf implements TranslateToJavabuf {
        ...
        public Message assignToJavabuf(Object x) {
            ...
            Short p = (Short) x;
            dev.resteasy.grpc.example.CC1_proto.gShort.Builder builder = dev.resteasy.grpc.example.CC1_proto.gShort
                    .newBuilder();
    ...
    static class gDouble_ToJavabuf implements TranslateToJavabuf {
        ...
        public Message assignToJavabuf(Object x) {
            ...
            Double p = (Double) x;
            dev.resteasy.grpc.example.CC1_proto.gDouble.Builder builder = dev.resteasy.grpc.example.CC1_proto.gDouble
                    .newBuilder();
    ...
    static class gBoolean_ToJavabuf implements TranslateToJavabuf {
        ...
        public Message assignToJavabuf(Object x) {
            ...
            Boolean p = (Boolean) x;
            dev.resteasy.grpc.example.CC1_proto.gBoolean.Builder builder = dev.resteasy.grpc.example.CC1_proto.gBoolean
                    .newBuilder();
    ...
    static class gString_ToJavabuf implements TranslateToJavabuf {
        ...
        public Message assignToJavabuf(Object x) {
            ...
            String p = (String) x;
            dev.resteasy.grpc.example.CC1_proto.gString.Builder builder = dev.resteasy.grpc.example.CC1_proto.gString
                    .newBuilder();
    ...
    static class gCharacter_ToJavabuf implements TranslateToJavabuf {
        ...
        public Message assignToJavabuf(Object x) {
            ...
            dev.resteasy.grpc.example.CC1_proto.gCharacter.Builder builder = dev.resteasy.grpc.example.CC1_proto.gCharacter
                    .newBuilder();
    ...
    static class gFloat_ToJavabuf implements TranslateToJavabuf {
        ...
        public Message assignToJavabuf(Object x) {
            ...
            Float p = (Float) x;
            dev.resteasy.grpc.example.CC1_proto.gFloat.Builder builder = dev.resteasy.grpc.example.CC1_proto.gFloat
                    .newBuilder();
    ...
    static class gInteger_ToJavabuf implements TranslateToJavabuf {
        ...
        public Message assignToJavabuf(Object x) {
            ...
            Integer p = (Integer) x;
            dev.resteasy.grpc.example.CC1_proto.gInteger.Builder builder = dev.resteasy.grpc.example.CC1_proto.gInteger
                    .newBuilder();
    ...
    static class java_util_LinkedHashMap_HIDDEN_Entry_ToJavabuf implements TranslateToJavabuf {
        private static Descriptor descriptor = dev.resteasy.grpc.example.CC1_proto.java_util_LinkedHashMap_HIDDEN_Entry
                .getDescriptor();
        private static List<AssignToJavabuf> assignList = new ArrayList<AssignToJavabuf>();
        ...
        static {
            for (FieldDescriptor f : descriptor.getFields()) {
                ...
                assignList.add(toJavabuf(getReturnNonPublicJavaClass("java.util.LinkedHashMap$Entry").getJavaClass(),
    ...
    static class java_util_LinkedHashMap_HIDDEN_Entry_FromJavabuf implements TranslateFromJavabuf {
        ...
        static {
            for (FieldDescriptor f : descriptor.getFields()) {
                ...
                assignList.add(fromJavabuf(getReturnNonPublicJavaClass("java.util.LinkedHashMap$Entry").getJavaClass(),
                        descriptor.findFieldByName(name)));
            }
        }
    ...
    static class java_util_HashMap_HIDDEN_TreeNode_ToJavabuf implements TranslateToJavabuf {
        private static Descriptor descriptor = dev.resteasy.grpc.example.CC1_proto.java_util_HashMap_HIDDEN_TreeNode
                .getDescriptor();
        private static List<AssignToJavabuf> assignList = new ArrayList<AssignToJavabuf>();
        ...
        static {
            for (FieldDescriptor f : descriptor.getFields()) {
                ...
                assignList.add(toJavabuf(getReturnNonPublicJavaClass("java.util.HashMap$TreeNode").getJavaClass(),
                        descriptor.findFieldByName(name)));
            }
        }
    ...
    static class java_util_HashMap_HIDDEN_TreeNode_FromJavabuf implements TranslateFromJavabuf {
        ...
        static {
            for (FieldDescriptor f : descriptor.getFields()) {
                ...
                assignList.add(fromJavabuf(getReturnNonPublicJavaClass("java.util.HashMap$TreeNode").getJavaClass(),
                        descriptor.findFieldByName(name)));
            }
        }
    ...
    static class java_util_ArrayList_HIDDEN_ListItr_ToJavabuf implements TranslateToJavabuf {
        private static Descriptor descriptor = dev.resteasy.grpc.example.CC1_proto.java_util_ArrayList_HIDDEN_ListItr
                .getDescriptor();
        private static List<AssignToJavabuf> assignList = new ArrayList<AssignToJavabuf>();
        ...
        static {
            for (FieldDescriptor f : descriptor.getFields()) {
                ...
                assignList.add(toJavabuf(getReturnNonPublicJavaClass("java.util.ArrayList$ListItr").getJavaClass(),
                        descriptor.findFieldByName(name)));
            }
        }
    ...
    static class java_util_ArrayList_HIDDEN_ListItr_FromJavabuf implements TranslateFromJavabuf {
        ...
        static {
            for (FieldDescriptor f : descriptor.getFields()) {
                ...
                assignList.add(fromJavabuf(getReturnNonPublicJavaClass("java.util.ArrayList$ListItr").getJavaClass(),
                        descriptor.findFieldByName(name)));
            }
        }
    ...
    static class java_util_HashMap_HIDDEN_KeyIterator_ToJavabuf implements TranslateToJavabuf {
        private static Descriptor descriptor = dev.resteasy.grpc.example.CC1_proto.java_util_HashMap_HIDDEN_KeyIterator
                .getDescriptor();
        private static List<AssignToJavabuf> assignList = new ArrayList<AssignToJavabuf>();
        ...
        static {
            for (FieldDescriptor f : descriptor.getFields()) {
                ...
                assignList.add(toJavabuf(getReturnNonPublicJavaClass("java.util.HashMap$KeyIterator").getJavaClass(),
                        descriptor.findFieldByName(name)));
            }
        }
    ...
    static class java_util_HashMap_HIDDEN_KeyIterator_FromJavabuf implements TranslateFromJavabuf {
        ...
        static {
            for (FieldDescriptor f : descriptor.getFields()) {
                ...
                assignList.add(fromJavabuf(getReturnNonPublicJavaClass("java.util.HashMap$KeyIterator").getJavaClass(),
                        descriptor.findFieldByName(name)));
            }
        }
    ...
    static class java_util_HashMap_HIDDEN_Values_ToJavabuf implements TranslateToJavabuf {
        private static Descriptor descriptor = dev.resteasy.grpc.example.CC1_proto.java_util_HashMap_HIDDEN_Values
                .getDescriptor();
        private static List<AssignToJavabuf> assignList = new ArrayList<AssignToJavabuf>();
        ...
        static {
            for (FieldDescriptor f : descriptor.getFields()) {
                ...
                assignList.add(toJavabuf(getReturnNonPublicJavaClass("java.util.HashMap$Values").getJavaClass(),
                        descriptor.findFieldByName(name)));
            }
        }
    ...
    static class java_util_HashMap_HIDDEN_Values_FromJavabuf implements TranslateFromJavabuf {
        ...
        static {
            for (FieldDescriptor f : descriptor.getFields()) {
                ...
                assignList.add(fromJavabuf(getReturnNonPublicJavaClass("java.util.HashMap$Values").getJavaClass(),
                        descriptor.findFieldByName(name)));
            }
        }
    ...
    static class java_util_HashMap_HIDDEN_EntrySet_ToJavabuf implements TranslateToJavabuf {
        private static Descriptor descriptor = dev.resteasy.grpc.example.CC1_proto.java_util_HashMap_HIDDEN_EntrySet
                .getDescriptor();
        private static List<AssignToJavabuf> assignList = new ArrayList<AssignToJavabuf>();
        ...
        static {
            for (FieldDescriptor f : descriptor.getFields()) {
                ...
                assignList.add(toJavabuf(getReturnNonPublicJavaClass("java.util.HashMap$EntrySet").getJavaClass(),
                        descriptor.findFieldByName(name)));
            }
        }
    ...
    static class java_util_HashMap_HIDDEN_EntrySet_FromJavabuf implements TranslateFromJavabuf {
        ...
        static {
            for (FieldDescriptor f : descriptor.getFields()) {
                ...
                assignList.add(fromJavabuf(getReturnNonPublicJavaClass("java.util.HashMap$EntrySet").getJavaClass(),
                        descriptor.findFieldByName(name)));
            }
        }
    ...
    static class java_util_HashMap_HIDDEN_ValueSpliterator_ToJavabuf implements TranslateToJavabuf {
        private static Descriptor descriptor = dev.resteasy.grpc.example.CC1_proto.java_util_HashMap_HIDDEN_ValueSpliterator
                .getDescriptor();
        private static List<AssignToJavabuf> assignList = new ArrayList<AssignToJavabuf>();
        ...
        static {
            for (FieldDescriptor f : descriptor.getFields()) {
                ...
                assignList.add(toJavabuf(getReturnNonPublicJavaClass("java.util.HashMap$ValueSpliterator").getJavaClass(),
                        descriptor.findFieldByName(name)));
            }
        }
    ...
    static class java_util_HashMap_HIDDEN_ValueSpliterator_FromJavabuf implements TranslateFromJavabuf {
        ...
        static {
            for (FieldDescriptor f : descriptor.getFields()) {
                ...
                assignList.add(fromJavabuf(getReturnNonPublicJavaClass("java.util.HashMap$ValueSpliterator").getJavaClass(),
                        descriptor.findFieldByName(name)));
            }
        }
    ...
    static class java_util_HashMap_HIDDEN_ValueIterator_ToJavabuf implements TranslateToJavabuf {
        private static Descriptor descriptor = dev.resteasy.grpc.example.CC1_proto.java_util_HashMap_HIDDEN_ValueIterator
                .getDescriptor();
        private static List<AssignToJavabuf> assignList = new ArrayList<AssignToJavabuf>();
        ...
        static {
            for (FieldDescriptor f : descriptor.getFields()) {
                ...
                assignList.add(toJavabuf(getReturnNonPublicJavaClass("java.util.HashMap$ValueIterator").getJavaClass(),
                        descriptor.findFieldByName(name)));
            }
        }
    ...
    static class java_util_HashMap_HIDDEN_ValueIterator_FromJavabuf implements TranslateFromJavabuf {
        ...
        static {
            for (FieldDescriptor f : descriptor.getFields()) {
                ...
                assignList.add(fromJavabuf(getReturnNonPublicJavaClass("java.util.HashMap$ValueIterator").getJavaClass(),
                        descriptor.findFieldByName(name)));
            }
        }
    ...
    static class dev_resteasy_grpc_example_CC1_INNER_InnerClass_ToJavabuf implements TranslateToJavabuf {
        private static Descriptor descriptor = dev.resteasy.grpc.example.CC1_proto.dev_resteasy_grpc_example_CC1_INNER_InnerClass
                .getDescriptor();
        private static List<AssignToJavabuf> assignList = new ArrayList<AssignToJavabuf>();
        ...
        public Message assignToJavabuf(Object c1) {
            ...
            dev_resteasy_grpc_example_CC1_INNER_InnerClass.Builder builder = dev_resteasy_grpc_example_CC1_INNER_InnerClass
                    .newBuilder();
            for (AssignToJavabuf assignTo : assignList) {
                try {
                    assignTo.assign(c1, builder);
    ...
    static class java_util_AbstractMap_INNER_SimpleEntry_ToJavabuf implements TranslateToJavabuf {
        private static Descriptor descriptor = dev.resteasy.grpc.example.CC1_proto.java_util_AbstractMap_INNER_SimpleEntry
                .getDescriptor();
        private static List<AssignToJavabuf> assignList = new ArrayList<AssignToJavabuf>();
    ...
    static class java_util_AbstractMap_INNER_SimpleImmutableEntry_ToJavabuf implements TranslateToJavabuf {
        private static Descriptor descriptor = dev.resteasy.grpc.example.CC1_proto.java_util_AbstractMap_INNER_SimpleImmutableEntry
                .getDescriptor();
        private static List<AssignToJavabuf> assignList = new ArrayList<AssignToJavabuf>();
        ...
        public Message assignToJavabuf(Object c1) {
            ...
            java_util_AbstractMap_INNER_SimpleImmutableEntry.Builder builder = java_util_AbstractMap_INNER_SimpleImmutableEntry
                    .newBuilder();
            for (AssignToJavabuf assignTo : assignList) {
                try {
                    assignTo.assign(c1, builder);
    ...
    static class java_util_HashMap_HIDDEN_KeySet_ToJavabuf implements TranslateToJavabuf {
        private static Descriptor descriptor = dev.resteasy.grpc.example.CC1_proto.java_util_HashMap_HIDDEN_KeySet
                .getDescriptor();
        private static List<AssignToJavabuf> assignList = new ArrayList<AssignToJavabuf>();
        ...
        static {
            for (FieldDescriptor f : descriptor.getFields()) {
                ...
                assignList.add(toJavabuf(getReturnNonPublicJavaClass("java.util.HashMap$KeySet").getJavaClass(),
                        descriptor.findFieldByName(name)));
            }
        }
    ...
    static class java_util_HashMap_HIDDEN_KeySet_FromJavabuf implements TranslateFromJavabuf {
        ...
        static {
            for (FieldDescriptor f : descriptor.getFields()) {
                ...
                assignList.add(fromJavabuf(getReturnNonPublicJavaClass("java.util.HashMap$KeySet").getJavaClass(),
                        descriptor.findFieldByName(name)));
            }
        }
    ...
    static class dev_resteasy_grpc_example_ArrayStuff_HIDDEN_Stuff_ToJavabuf implements TranslateToJavabuf {
        private static Descriptor descriptor = dev.resteasy.grpc.example.CC1_proto.dev_resteasy_grpc_example_ArrayStuff_HIDDEN_Stuff
                .getDescriptor();
        private static List<AssignToJavabuf> assignList = new ArrayList<AssignToJavabuf>();
        ...
        static {
            for (FieldDescriptor f : descriptor.getFields()) {
                ...
                assignList
                        .add(toJavabuf(getReturnNonPublicJavaClass("dev.resteasy.grpc.example.ArrayStuff$Stuff").getJavaClass(),
                                descriptor.findFieldByName(name)));
            }
        }
        ...
        public Message assignToJavabuf(Object c1) {
            ...
            dev_resteasy_grpc_example_ArrayStuff_HIDDEN_Stuff.Builder builder = dev_resteasy_grpc_example_ArrayStuff_HIDDEN_Stuff
                    .newBuilder();
            for (AssignToJavabuf assignTo : assignList) {
                try {
                    assignTo.assign(c1, builder);
    ...
    static class dev_resteasy_grpc_example_ArrayStuff_HIDDEN_Stuff_FromJavabuf implements TranslateFromJavabuf {
        ...
        static {
            for (FieldDescriptor f : descriptor.getFields()) {
                ...
                assignList.add(
                        fromJavabuf(getReturnNonPublicJavaClass("dev.resteasy.grpc.example.ArrayStuff$Stuff").getJavaClass(),
                                descriptor.findFieldByName(name)));
            }
        }
    ...
    static class java_util_ArrayList_HIDDEN_ArrayListSpliterator_ToJavabuf implements TranslateToJavabuf {
        private static Descriptor descriptor = dev.resteasy.grpc.example.CC1_proto.java_util_ArrayList_HIDDEN_ArrayListSpliterator
                .getDescriptor();
        private static List<AssignToJavabuf> assignList = new ArrayList<AssignToJavabuf>();
        ...
        static {
            for (FieldDescriptor f : descriptor.getFields()) {
                ...
                assignList.add(toJavabuf(getReturnNonPublicJavaClass("java.util.ArrayList$ArrayListSpliterator").getJavaClass(),
                        descriptor.findFieldByName(name)));
            }
        }
        ...
        public Message assignToJavabuf(Object c1) {
            ...
            java_util_ArrayList_HIDDEN_ArrayListSpliterator.Builder builder = java_util_ArrayList_HIDDEN_ArrayListSpliterator
                    .newBuilder();
            for (AssignToJavabuf assignTo : assignList) {
                try {
                    assignTo.assign(c1, builder);
    ...
    static class java_util_ArrayList_HIDDEN_ArrayListSpliterator_FromJavabuf implements TranslateFromJavabuf {
        ...
        static {
            for (FieldDescriptor f : descriptor.getFields()) {
                ...
                assignList
                        .add(fromJavabuf(getReturnNonPublicJavaClass("java.util.ArrayList$ArrayListSpliterator").getJavaClass(),
                                descriptor.findFieldByName(name)));
            }
        }
    ...
    static class java_util_ArrayList_HIDDEN_SubList_ToJavabuf implements TranslateToJavabuf {
        private static Descriptor descriptor = dev.resteasy.grpc.example.CC1_proto.java_util_ArrayList_HIDDEN_SubList
                .getDescriptor();
        private static List<AssignToJavabuf> assignList = new ArrayList<AssignToJavabuf>();
        ...
        static {
            for (FieldDescriptor f : descriptor.getFields()) {
                ...
                assignList.add(toJavabuf(getReturnNonPublicJavaClass("java.util.ArrayList$SubList").getJavaClass(),
                        descriptor.findFieldByName(name)));
            }
        }
    ...
    static class java_util_ArrayList_HIDDEN_SubList_FromJavabuf implements TranslateFromJavabuf {
        ...
        static {
            for (FieldDescriptor f : descriptor.getFields()) {
                ...
                assignList.add(fromJavabuf(getReturnNonPublicJavaClass("java.util.ArrayList$SubList").getJavaClass(),
                        descriptor.findFieldByName(name)));
            }
        }
    ...
    static class java_util_HashMap_HIDDEN_UnsafeHolder_ToJavabuf implements TranslateToJavabuf {
        private static Descriptor descriptor = dev.resteasy.grpc.example.CC1_proto.java_util_HashMap_HIDDEN_UnsafeHolder
                .getDescriptor();
        private static List<AssignToJavabuf> assignList = new ArrayList<AssignToJavabuf>();
        ...
        static {
            for (FieldDescriptor f : descriptor.getFields()) {
                ...
                assignList.add(toJavabuf(getReturnNonPublicJavaClass("java.util.HashMap$UnsafeHolder").getJavaClass(),
                        descriptor.findFieldByName(name)));
            }
        }
    ...
    static class java_util_HashMap_HIDDEN_UnsafeHolder_FromJavabuf implements TranslateFromJavabuf {
        ...
        static {
            for (FieldDescriptor f : descriptor.getFields()) {
                ...
                assignList.add(fromJavabuf(getReturnNonPublicJavaClass("java.util.HashMap$UnsafeHolder").getJavaClass(),
                        descriptor.findFieldByName(name)));
            }
        }
    ...
    static class java_util_AbstractList_HIDDEN_ListItr_ToJavabuf implements TranslateToJavabuf {
        private static Descriptor descriptor = dev.resteasy.grpc.example.CC1_proto.java_util_AbstractList_HIDDEN_ListItr
                .getDescriptor();
        private static List<AssignToJavabuf> assignList = new ArrayList<AssignToJavabuf>();
        ...
        static {
            for (FieldDescriptor f : descriptor.getFields()) {
                ...
                assignList.add(toJavabuf(getReturnNonPublicJavaClass("java.util.AbstractList$ListItr").getJavaClass(),
                        descriptor.findFieldByName(name)));
            }
        }
    ...
    static class java_util_AbstractList_HIDDEN_ListItr_FromJavabuf implements TranslateFromJavabuf {
        ...
        static {
            for (FieldDescriptor f : descriptor.getFields()) {
                ...
                assignList.add(fromJavabuf(getReturnNonPublicJavaClass("java.util.AbstractList$ListItr").getJavaClass(),
                        descriptor.findFieldByName(name)));
            }
        }
    ...
    static class dev_resteasy_grpc_example_CC3_INNER_CC3_Sub_ToJavabuf implements TranslateToJavabuf {
        private static Descriptor descriptor = dev.resteasy.grpc.example.CC1_proto.dev_resteasy_grpc_example_CC3_INNER_CC3_Sub
                .getDescriptor();
        private static List<AssignToJavabuf> assignList = new ArrayList<AssignToJavabuf>();
        ...
        public Message assignToJavabuf(Object c1) {
            ...
            dev_resteasy_grpc_example_CC3_INNER_CC3_Sub.Builder builder = dev_resteasy_grpc_example_CC3_INNER_CC3_Sub
                    .newBuilder();
            for (AssignToJavabuf assignTo : assignList) {
                try {
                    assignTo.assign(c1, builder);
    ...
    static class java_util_ArrayList_HIDDEN_Itr_ToJavabuf implements TranslateToJavabuf {
        private static Descriptor descriptor = dev.resteasy.grpc.example.CC1_proto.java_util_ArrayList_HIDDEN_Itr
                .getDescriptor();
        private static List<AssignToJavabuf> assignList = new ArrayList<AssignToJavabuf>();
        ...
        static {
            for (FieldDescriptor f : descriptor.getFields()) {
                ...
                assignList.add(toJavabuf(getReturnNonPublicJavaClass("java.util.ArrayList$Itr").getJavaClass(),
                        descriptor.findFieldByName(name)));
            }
        }
    ...
    static class java_util_ArrayList_HIDDEN_Itr_FromJavabuf implements TranslateFromJavabuf {
        ...
        static {
            for (FieldDescriptor f : descriptor.getFields()) {
                ...
                assignList.add(fromJavabuf(getReturnNonPublicJavaClass("java.util.ArrayList$Itr").getJavaClass(),
                        descriptor.findFieldByName(name)));
            }
        }
    ...
    static class java_util_HashMap_HIDDEN_EntryIterator_ToJavabuf implements TranslateToJavabuf {
        private static Descriptor descriptor = dev.resteasy.grpc.example.CC1_proto.java_util_HashMap_HIDDEN_EntryIterator
                .getDescriptor();
        private static List<AssignToJavabuf> assignList = new ArrayList<AssignToJavabuf>();
        ...
        static {
            for (FieldDescriptor f : descriptor.getFields()) {
                ...
                assignList.add(toJavabuf(getReturnNonPublicJavaClass("java.util.HashMap$EntryIterator").getJavaClass(),
                        descriptor.findFieldByName(name)));
            }
        }
    ...
    static class java_util_HashMap_HIDDEN_EntryIterator_FromJavabuf implements TranslateFromJavabuf {
        ...
        static {
            for (FieldDescriptor f : descriptor.getFields()) {
                ...
                assignList.add(fromJavabuf(getReturnNonPublicJavaClass("java.util.HashMap$EntryIterator").getJavaClass(),
                        descriptor.findFieldByName(name)));
            }
        }
    ...
    static class java_util_HashMap_HIDDEN_HashIterator_ToJavabuf implements TranslateToJavabuf {
        private static Descriptor descriptor = dev.resteasy.grpc.example.CC1_proto.java_util_HashMap_HIDDEN_HashIterator
                .getDescriptor();
        private static List<AssignToJavabuf> assignList = new ArrayList<AssignToJavabuf>();
        ...
        static {
            for (FieldDescriptor f : descriptor.getFields()) {
                ...
                assignList.add(toJavabuf(getReturnNonPublicJavaClass("java.util.HashMap$HashIterator").getJavaClass(),
                        descriptor.findFieldByName(name)));
            }
        }
    ...
    static class java_util_AbstractList_HIDDEN_RandomAccessSpliterator_ToJavabuf implements TranslateToJavabuf {
        private static Descriptor descriptor = dev.resteasy.grpc.example.CC1_proto.java_util_AbstractList_HIDDEN_RandomAccessSpliterator
                .getDescriptor();
        private static List<AssignToJavabuf> assignList = new ArrayList<AssignToJavabuf>();
        ...
        static {
            for (FieldDescriptor f : descriptor.getFields()) {
                ...
                assignList.add(
                        toJavabuf(getReturnNonPublicJavaClass("java.util.AbstractList$RandomAccessSpliterator").getJavaClass(),
                                descriptor.findFieldByName(name)));
            }
        }
        ...
        public Message assignToJavabuf(Object c1) {
            ...
            java_util_AbstractList_HIDDEN_RandomAccessSpliterator.Builder builder = java_util_AbstractList_HIDDEN_RandomAccessSpliterator
                    .newBuilder();
            for (AssignToJavabuf assignTo : assignList) {
                try {
                    assignTo.assign(c1, builder);
    ...
    static class dev_resteasy_grpc_example___CC9_ToJavabuf implements TranslateToJavabuf {
        private static Descriptor descriptor = dev.resteasy.grpc.example.CC1_proto.dev_resteasy_grpc_example___CC9
                .getDescriptor();
        private static List<AssignToJavabuf> assignList = new ArrayList<AssignToJavabuf>();
    ...
    static class java_util_HashMap_HIDDEN_KeySpliterator_ToJavabuf implements TranslateToJavabuf {
        private static Descriptor descriptor = dev.resteasy.grpc.example.CC1_proto.java_util_HashMap_HIDDEN_KeySpliterator
                .getDescriptor();
        private static List<AssignToJavabuf> assignList = new ArrayList<AssignToJavabuf>();
        ...
        static {
            for (FieldDescriptor f : descriptor.getFields()) {
                ...
                assignList.add(toJavabuf(getReturnNonPublicJavaClass("java.util.HashMap$KeySpliterator").getJavaClass(),
                        descriptor.findFieldByName(name)));
            }
        }
    ...
    static class java_util_HashMap_HIDDEN_KeySpliterator_FromJavabuf implements TranslateFromJavabuf {
        ...
        static {
            for (FieldDescriptor f : descriptor.getFields()) {
                ...
                assignList.add(fromJavabuf(getReturnNonPublicJavaClass("java.util.HashMap$KeySpliterator").getJavaClass(),
                        descriptor.findFieldByName(name)));
            }
        }
    ...
    static class java_util_AbstractList_HIDDEN_SubList_ToJavabuf implements TranslateToJavabuf {
        private static Descriptor descriptor = dev.resteasy.grpc.example.CC1_proto.java_util_AbstractList_HIDDEN_SubList
                .getDescriptor();
        private static List<AssignToJavabuf> assignList = new ArrayList<AssignToJavabuf>();
        ...
        static {
            for (FieldDescriptor f : descriptor.getFields()) {
                ...
                assignList.add(toJavabuf(getReturnNonPublicJavaClass("java.util.AbstractList$SubList").getJavaClass(),
                        descriptor.findFieldByName(name)));
            }
        }
    ...
    static class java_util_AbstractList_HIDDEN_SubList_FromJavabuf implements TranslateFromJavabuf {
        ...
        static {
            for (FieldDescriptor f : descriptor.getFields()) {
                ...
                assignList.add(fromJavabuf(getReturnNonPublicJavaClass("java.util.AbstractList$SubList").getJavaClass(),
                        descriptor.findFieldByName(name)));
            }
        }
    ...
    static class dev_resteasy_grpc_example___CC6_ToJavabuf implements TranslateToJavabuf {
        private static Descriptor descriptor = dev.resteasy.grpc.example.CC1_proto.dev_resteasy_grpc_example___CC6
                .getDescriptor();
        private static List<AssignToJavabuf> assignList = new ArrayList<AssignToJavabuf>();
    ...
    static class dev_resteasy_grpc_example___CC7_ToJavabuf implements TranslateToJavabuf {
        private static Descriptor descriptor = dev.resteasy.grpc.example.CC1_proto.dev_resteasy_grpc_example___CC7
                .getDescriptor();
        private static List<AssignToJavabuf> assignList = new ArrayList<AssignToJavabuf>();
    ...
    static class java_util_HashMap_HIDDEN_EntrySpliterator_ToJavabuf implements TranslateToJavabuf {
        private static Descriptor descriptor = dev.resteasy.grpc.example.CC1_proto.java_util_HashMap_HIDDEN_EntrySpliterator
                .getDescriptor();
        private static List<AssignToJavabuf> assignList = new ArrayList<AssignToJavabuf>();
        ...
        static {
            for (FieldDescriptor f : descriptor.getFields()) {
                ...
                assignList.add(toJavabuf(getReturnNonPublicJavaClass("java.util.HashMap$EntrySpliterator").getJavaClass(),
                        descriptor.findFieldByName(name)));
            }
        }
    ...
    static class java_util_HashMap_HIDDEN_EntrySpliterator_FromJavabuf implements TranslateFromJavabuf {
        ...
        static {
            for (FieldDescriptor f : descriptor.getFields()) {
                ...
                assignList.add(fromJavabuf(getReturnNonPublicJavaClass("java.util.HashMap$EntrySpliterator").getJavaClass(),
                        descriptor.findFieldByName(name)));
            }
        }
    ...
    static class java_util_AbstractList_HIDDEN_RandomAccessSubList_ToJavabuf implements TranslateToJavabuf {
        private static Descriptor descriptor = dev.resteasy.grpc.example.CC1_proto.java_util_AbstractList_HIDDEN_RandomAccessSubList
                .getDescriptor();
        private static List<AssignToJavabuf> assignList = new ArrayList<AssignToJavabuf>();
        ...
        static {
            for (FieldDescriptor f : descriptor.getFields()) {
                ...
                assignList
                        .add(toJavabuf(getReturnNonPublicJavaClass("java.util.AbstractList$RandomAccessSubList").getJavaClass(),
                                descriptor.findFieldByName(name)));
            }
        }
        ...
        public Message assignToJavabuf(Object c1) {
            ...
            java_util_AbstractList_HIDDEN_RandomAccessSubList.Builder builder = java_util_AbstractList_HIDDEN_RandomAccessSubList
                    .newBuilder();
            for (AssignToJavabuf assignTo : assignList) {
                try {
                    assignTo.assign(c1, builder);
    ...
    static class java_util_AbstractList_HIDDEN_RandomAccessSubList_FromJavabuf implements TranslateFromJavabuf {
        ...
        static {
            for (FieldDescriptor f : descriptor.getFields()) {
                ...
                assignList.add(
                        fromJavabuf(getReturnNonPublicJavaClass("java.util.AbstractList$RandomAccessSubList").getJavaClass(),
                                descriptor.findFieldByName(name)));
            }
        }
    ...
    static class dev_resteasy_grpc_example___CC4_ToJavabuf implements TranslateToJavabuf {
        private static Descriptor descriptor = dev.resteasy.grpc.example.CC1_proto.dev_resteasy_grpc_example___CC4
                .getDescriptor();
        private static List<AssignToJavabuf> assignList = new ArrayList<AssignToJavabuf>();
    ...
    static class dev_resteasy_grpc_example___ArrayStuff_ToJavabuf implements TranslateToJavabuf {
        private static Descriptor descriptor = dev.resteasy.grpc.example.CC1_proto.dev_resteasy_grpc_example___ArrayStuff
                .getDescriptor();
        private static List<AssignToJavabuf> assignList = new ArrayList<AssignToJavabuf>();
    ...
    static class java_util_HashMap_HIDDEN_HashMapSpliterator_ToJavabuf implements TranslateToJavabuf {
        private static Descriptor descriptor = dev.resteasy.grpc.example.CC1_proto.java_util_HashMap_HIDDEN_HashMapSpliterator
                .getDescriptor();
        private static List<AssignToJavabuf> assignList = new ArrayList<AssignToJavabuf>();
        ...
        static {
            for (FieldDescriptor f : descriptor.getFields()) {
                ...
                assignList.add(toJavabuf(getReturnNonPublicJavaClass("java.util.HashMap$HashMapSpliterator").getJavaClass(),
                        descriptor.findFieldByName(name)));
            }
        }
        ...
        public Message assignToJavabuf(Object c1) {
            ...
            java_util_HashMap_HIDDEN_HashMapSpliterator.Builder builder = java_util_HashMap_HIDDEN_HashMapSpliterator
                    .newBuilder();
            for (AssignToJavabuf assignTo : assignList) {
                try {
                    assignTo.assign(c1, builder);
    ...
    static class java_util_HashMap_HIDDEN_HashMapSpliterator_FromJavabuf implements TranslateFromJavabuf {
        ...
        static {
            for (FieldDescriptor f : descriptor.getFields()) {
                ...
                assignList.add(fromJavabuf(getReturnNonPublicJavaClass("java.util.HashMap$HashMapSpliterator").getJavaClass(),
                        descriptor.findFieldByName(name)));
            }
        }
    ...
    static class dev_resteasy_grpc_example___CC2_ToJavabuf implements TranslateToJavabuf {
        private static Descriptor descriptor = dev.resteasy.grpc.example.CC1_proto.dev_resteasy_grpc_example___CC2
                .getDescriptor();
        private static List<AssignToJavabuf> assignList = new ArrayList<AssignToJavabuf>();
    ...
    static class java_util_HashMap_HIDDEN_Node_ToJavabuf implements TranslateToJavabuf {
        private static Descriptor descriptor = dev.resteasy.grpc.example.CC1_proto.java_util_HashMap_HIDDEN_Node
                .getDescriptor();
        private static List<AssignToJavabuf> assignList = new ArrayList<AssignToJavabuf>();
        ...
        static {
            for (FieldDescriptor f : descriptor.getFields()) {
                ...
                assignList.add(toJavabuf(getReturnNonPublicJavaClass("java.util.HashMap$Node").getJavaClass(),
                        descriptor.findFieldByName(name)));
            }
        }
    ...
    static class java_util_HashMap_HIDDEN_Node_FromJavabuf implements TranslateFromJavabuf {
        ...
        static {
            for (FieldDescriptor f : descriptor.getFields()) {
                ...
                assignList.add(fromJavabuf(getReturnNonPublicJavaClass("java.util.HashMap$Node").getJavaClass(),
                        descriptor.findFieldByName(name)));
            }
        }
    ...
    static class java_util_AbstractList_HIDDEN_Itr_ToJavabuf implements TranslateToJavabuf {
        private static Descriptor descriptor = dev.resteasy.grpc.example.CC1_proto.java_util_AbstractList_HIDDEN_Itr
                .getDescriptor();
        private static List<AssignToJavabuf> assignList = new ArrayList<AssignToJavabuf>();
        ...
        static {
            for (FieldDescriptor f : descriptor.getFields()) {
                ...
                assignList.add(toJavabuf(getReturnNonPublicJavaClass("java.util.AbstractList$Itr").getJavaClass(),
                        descriptor.findFieldByName(name)));
            }
        }
    ...
    static class java_util_AbstractList_HIDDEN_Itr_FromJavabuf implements TranslateFromJavabuf {
        ...
        static {
            for (FieldDescriptor f : descriptor.getFields()) {
                ...
                assignList.add(fromJavabuf(getReturnNonPublicJavaClass("java.util.AbstractList$Itr").getJavaClass(),
                        descriptor.findFieldByName(name)));
            }
        }
    ...
    static class dev_resteasy_grpc_example___IntfImpl_ToJavabuf implements TranslateToJavabuf {
        private static Descriptor descriptor = dev.resteasy.grpc.example.CC1_proto.dev_resteasy_grpc_example___IntfImpl
                .getDescriptor();
        private static List<AssignToJavabuf> assignList = new ArrayList<AssignToJavabuf>();
    ...
    static class dev_resteasy_grpc_bridge_runtime_sse___SseEvent_ToJavabuf implements TranslateToJavabuf {
        private static Descriptor descriptor = dev.resteasy.grpc.example.CC1_proto.dev_resteasy_grpc_bridge_runtime_sse___SseEvent
                .getDescriptor();
        private static List<AssignToJavabuf> assignList = new ArrayList<AssignToJavabuf>();
        ...
        static {
            for (FieldDescriptor f : descriptor.getFields()) {
                ...
                assignList
                        .add(toJavabuf(dev.resteasy.grpc.bridge.runtime.sse.SseEvent.class, descriptor.findFieldByName(name)));
            }
        }
        ...
        public Message assignToJavabuf(Object c1) {
            ...
            dev_resteasy_grpc_bridge_runtime_sse___SseEvent.Builder builder = dev_resteasy_grpc_bridge_runtime_sse___SseEvent
                    .newBuilder();
            for (AssignToJavabuf assignTo : assignList) {
                try {
                    assignTo.assign(c1, builder);
    ...
    static class dev_resteasy_grpc_bridge_runtime_sse___SseEvent_FromJavabuf implements TranslateFromJavabuf {
        ...
        static {
            for (FieldDescriptor f : descriptor.getFields()) {
                ...
                assignList.add(
                        fromJavabuf(dev.resteasy.grpc.bridge.runtime.sse.SseEvent.class, descriptor.findFieldByName(name)));
            }
        }
    ...
    static class dev_resteasy_grpc_example___CC5_ToJavabuf implements TranslateToJavabuf {
        private static Descriptor descriptor = dev.resteasy.grpc.example.CC1_proto.dev_resteasy_grpc_example___CC5
                .getDescriptor();
        private static List<AssignToJavabuf> assignList = new ArrayList<AssignToJavabuf>();
    ...
    static class dev_resteasy_grpc_example___CC3_ToJavabuf implements TranslateToJavabuf {
        private static Descriptor descriptor = dev.resteasy.grpc.example.CC1_proto.dev_resteasy_grpc_example___CC3
                .getDescriptor();
        private static List<AssignToJavabuf> assignList = new ArrayList<AssignToJavabuf>();
