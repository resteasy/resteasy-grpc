...
public class ArrayUtility {
    ...
    public static Object getArray(JavabufTranslator translator, dev_resteasy_grpc_arrays___ArrayHolder ah) throws Exception {
        ...
        switch (ah.getComponentClass()) {
            ...
            case "java.lang.Byte": {
                List<Array_proto.dev_resteasy_grpc_arrays___Byte> list = ah.getDevResteasyGrpcArraysByteWArrayField().getByteFieldList();
            ...
            case "java.lang.Short": {
                List<Array_proto.dev_resteasy_grpc_arrays___Short> list = ah.getDevResteasyGrpcArraysShortWArrayField().getShortFieldList();
                Short[] ss = new Short[list.size()];
                for (int i = 0; i < ss.length; i++) {
            ...
            case "int": {
                List<Integer> list = ah.getDevResteasyGrpcArraysIntArrayField().getIntFieldList();
            ...
            case "java.lang.Integer": {
                List<dev_resteasy_grpc_arrays___Integer> list = ah.getDevResteasyGrpcArraysIntegerWArrayField().getIntegerFieldList();
            ...
            case "java.lang.Long": {
               List<dev_resteasy_grpc_arrays___Long> list = ah.getDevResteasyGrpcArraysLongWArrayField().getLongFieldList();
               Long[] ls = new Long[list.size()];
               for (int i = 0; i < ls.length; i++) {
    ...
    public static dev_resteasy_grpc_arrays___ArrayHolder getHolder(JavabufTranslator translator, Object o) {
        ...
        switch (componentClassName) {
            ...
            case "boolean": {
                ...
                return ahBuilder.setDevResteasyGrpcArraysBooleanArrayField(baBuilder).setComponentClass("boolean").build();
            }
            ...
            case "java.lang.Boolean": {
                ...
                return ahBuilder.setDevResteasyGrpcArraysBooleanWArrayField(bawBuilder).setComponentClass("java.lang.Boolean").build();
            }
            ...
            case "java.lang.Byte": {
               ...
               return ahBuilder.setDevResteasyGrpcArraysByteWArrayField(bwaBuilder).setComponentClass("java.lang.Byte").build();
           }

            case "short": {
               short[] ss = (short[]) o;
               dev_resteasy_grpc_arrays___shortArray.Builder sBuilder = dev_resteasy_grpc_arrays___shortArray.newBuilder();
               for (int i = 0; i < ss.length; i++) {
            ...
            case "java.lang.Short": {
                ...
                return ahBuilder.setDevResteasyGrpcArraysShortWArrayField(swaBuilder).setComponentClass("java.lang.Short").build();
            }
            ...
            case "int": {
               ...
               return ahBuilder.setDevResteasyGrpcArraysIntArrayField(iBuilder).setComponentClass("int").build();
            }
            ...
            case "java.lang.Integer": {
                ...
                return ahBuilder.setDevResteasyGrpcArraysIntegerWArrayField(iwaBuilder).setComponentClass("java.lang.Integer").build();
            }

            case "long": {
               long[] ls = (long[]) o;
               dev_resteasy_grpc_arrays___longArray.Builder lBuilder = dev_resteasy_grpc_arrays___longArray.newBuilder();
               for (int i = 0; i < ls.length; i++) {
            ...
            case "java.lang.Long": {
                ...
                return ahBuilder.setDevResteasyGrpcArraysLongWArrayField(lwaBuilder).setComponentClass("java.lang.Long").build();
            }
            ...
            //                }
            //                return .setAnyArrayField(builder).setComponentClass(componentClassName).build();
            //            }
        }return null;
