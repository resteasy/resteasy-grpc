...
public class ArrayUtility {
    ...
    public static Object getArray(JavabufTranslator translator, Array_proto.dev_resteasy_grpc_arrays___ArrayHolder ah, String outerClassName)
            throws Exception {
...
//        String protobufComponentClass = Utility.extractTypeFromAny(list.get(0), null, null)
        ...
        if (ah.getBottom()) {
        	Class protobufComponentType = Utility.extractTypeFromAny(list.get(0), Thread.currentThread().getContextClassLoader(), outerClassName);
...
//        		System.out.println(array.getClass());
        	...
        	Class protobufComponentType = Utility.extractTypeFromAny(list.get(0), Thread.currentThread().getContextClassLoader(), "Array_proto");
        	for (int i = 0; i < list.size(); i++) {
//        		Object o = translator.translateFromJavabuf(list.get(i).unpack(protobufComponentType));
//        		System.out.println(o.getClass());
//        		System.out.println(array.getClass());
